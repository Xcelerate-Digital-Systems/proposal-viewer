...
export const REVIEW_STATUS_CONFIG: Record<FeedbackStatus, ReviewStatusDef> = {
  ...
  in_progress: {
    ...
    dot: 'bg-teal-500', bg: 'bg-teal-100', text: 'text-teal-700', border: 'border-teal-200',
    symbol: '◴', icon: <Loader2 size={13} />,
  },
  internal_review: {
    value: 'internal_review', label: 'Internal Review', hex: '#3b82f6',
    dot: 'bg-blue-500', bg: 'bg-blue-100', text: 'text-blue-700', border: 'border-blue-200',
    symbol: '◉', icon: <Eye size={13} />,
  },
  client_review: {
    value: 'client_review', label: 'Client Review', hex: '#f59e0b',
    dot: 'bg-amber-500', bg: 'bg-amber-100', text: 'text-amber-700', border: 'border-amber-200',
    symbol: '!', icon: <Users size={13} />,
  },
  revision_needed: {
    value: 'revision_needed', label: 'Revision Needed', hex: '#f97316',
    dot: 'bg-orange-500', bg: 'bg-orange-100', text: 'text-orange-700', border: 'border-orange-200',
    symbol: '↻', icon: <RefreshCw size={13} />,
  },
  approved: {
    value: 'approved', label: 'Approved', hex: '#10b981',
    dot: 'bg-emerald-500', bg: 'bg-emerald-100', text: 'text-emerald-700', border: 'border-emerald-200',
    symbol: '✓', icon: <CheckCircle2 size={13} />,
  },
  rejected: {
    value: 'rejected', label: 'Rejected', hex: '#ef4444',
    dot: 'bg-red-500', bg: 'bg-red-100', text: 'text-red-700', border: 'border-red-200',
