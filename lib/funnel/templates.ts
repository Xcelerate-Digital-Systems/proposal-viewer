...
export const FUNNEL_TEMPLATES: FunnelTemplate[] = [
  ...
  },
  {
    ...
    edges: [
      { from: 'social',  to: 'land' },
      { from: 'seo',     to: 'land' },
      { from: 'land',    to: 'welcome' },
      { from: 'welcome', to: 'sponsor' },
    ],
  },
  {
    slug: 'agency-pitch',
    name: 'Agency Pitch Funnel',
  ...
  },
  {
    ...
    edges: [
      { from: 'maps',  to: 'site' },
      { from: 'ads',   to: 'site' },
      { from: 'site',  to: 'form', split_percent: 60 },
      { from: 'site',  to: 'phone', split_percent: 40 },
      { from: 'form',  to: 'appt' },
      { from: 'phone', to: 'appt' },
    ],
  },
