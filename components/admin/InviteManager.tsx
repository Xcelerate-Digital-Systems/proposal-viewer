                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5 ml-3">
                      <button
                        ...
                        className="p-1.5 rounded-lg hover:bg-surface text-faint hover:text-muted transition-colors disabled:opacity-50"
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-lg hover:bg-surface text-faint hover:text-muted transition-colors"
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-lg hover:bg-red-50 text-faint hover:text-red-500 transition-colors"
                        title="Revoke invite"
                      >
                        <X size={14} />
                      </button>
