        ...
        {preview ? (
          <div className="relative">
            ...
            <button
              type="button"
              onClick={clearFile}
              className="absolute top-2 right-2 p-1 bg-white/90 rounded-full border border-edge-strong text-dim hover:text-red-500 transition-colors"
            >
              <X size={14} />
            </button>
          ...
          <button
            ...
            className="w-full border-2 border-dashed border-edge-strong rounded-lg p-8 text-center hover:border-teal hover:bg-teal/5 transition-colors"
          >
            <Upload size={24} className="mx-auto mb-2 text-faint" />
            <p className="text-sm font-medium text-prose">Click to upload</p>
            <p className="text-xs text-faint mt-1">PNG, JPG, GIF, WebP up to 10MB</p>
          </button>
        )}
      </div>
