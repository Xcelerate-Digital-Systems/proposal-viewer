// components/admin/text-editor/RichTextToolbar.tsx
'use client';
...
export default function RichTextToolbar({ editor, className }: RichTextToolbarProps) {
  ...
  return (
    <div className={`flex flex-wrap items-center gap-1 px-2.5 py-2 bg-surface border-b border-edge-strong z-20 relative ${className ?? ''}`}>
      {/* Undo/Redo */}
