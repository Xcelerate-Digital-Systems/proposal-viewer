...
export default function DynamicFieldNodeView({ node }: NodeViewProps) {
  ...
  return (
    <NodeViewWrapper as="span" className="inline">
      <span
        className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded text-xs font-medium bg-teal text-white cursor-default select-none whitespace-nowrap align-baseline"
