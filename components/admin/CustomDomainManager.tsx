    ...
    <div className="bg-white border border-gray-100 rounded-[14px] p-5 ">
      ...
      <div className="flex gap-2 mb-3">
        <input
          ...
          className="flex-1 px-3 py-2 rounded-lg bg-surface border border-gray-100 text-sm text-ink placeholder:text-faint focus:outline-none focus:ring-2 focus:ring-teal/20 /40 disabled:opacity-50 disabled:cursor-not-allowed"
        />
        {isOwner && (
          <>
