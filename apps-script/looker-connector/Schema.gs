...
var RATE_METRICS = [
  { id: 'frequency',                         name: 'Frequency',                        type: 'NUMBER',       formula: 'SUM(impressions) / SUM(reach)',        desc: 'Avg times each person saw your ad. Computed: impressions ÷ reach. Note: across multiple rows reach double-counts users seen by more than one ad/day, so grouped frequency is an approximation.' },
