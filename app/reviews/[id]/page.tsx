...
function ReviewDetailGate({ isSuperAdmin, projectId, companyId, userId }: {
  ...
  return <ProjectDetailContent projectId={projectId} companyId={companyId} userId={userId} />;
}
...
function ProjectDetailContent({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Sticky header */}
      <div className="sticky top-0 z-10 bg-gray-50 px-6 lg:px-10 pt-6 pb-4 border-b border-gray-200 lg:border-b-0">
        {/* Back link */}
        <Link
          href="/reviews"
