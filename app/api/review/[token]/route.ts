...
const ITEM_COLUMNS = 'id, review_project_id, title, type, status, sort_order, url, html_content, share_token, ad_platform, ad_headline, ad_copy, ad_cta, image_url, ad_creative_url, ad_creatives, carousel_cards, sms_body, active_version_id, meta_ad_variants, email_subject, email_preheader, email_body, google_ad_data, board_x, board_y, board_color, page_path, parent_item_id, figma_file_key, figma_frame_name, share_password_hash, share_expires_at, created_at, updated_at';
...
const VERSION_COLUMNS = 'id, review_item_id, version_number, notes, url, html_content, ad_headline, ad_copy, ad_cta, image_url, sms_body, screenshot_url, ad_creative_url, ad_creatives, carousel_cards, ad_platform, meta_ad_variants, email_subject, email_preheader, email_body, created_at';
